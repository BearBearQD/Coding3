...
namespace NodeCanvas.Tasks.Actions {
	...
	public class ChasingAndFighting_AT : ActionTask {
		...
		protected override void OnUpdate() {
            ...
            agents.value.SetDestination(objectsInRange[0].transform.position);

            Collider[] objectsFightingInRange = Physics.OverlapSphere(agent.transform.position, scanRadius, targetMask);
